...
- [`docs/UI_SCREENSHOTS.md`](docs/UI_SCREENSHOTS.md)
...
- [`docs/UI_SCREENSHOTS.md`](docs/UI_SCREENSHOTS.md) - current user-interface screenshots and screen naming
